...
export default function Lifestyle() {
  return (
    <div>
       <section className="eblog-featured-post-area area-2 tp-section-gapBottom">
        <div className="container">
            <div className="section-inner">
                <div className="row g-5 sticky-coloum-wrap">
                    <div className="col-xl-9">
                        <div className="left-side-post-area">
                            <div className="featured-post area-2 tp-section-gapBottom">
                                <div className="section-title-area">
                                    <h3 className="section-title">Life Style</h3>
                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="eblog-featured-news style-two big">
                                                ...
                                                <div className="blog-content">
                                                    ...
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">We Spent Hours Finding The Best <br/> Dresses of 2024—Here Are the Top 57</a></h4>
                                                    <a href="#" className="text-btn color-two">Continue Reading</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                ...
                                                <div className="blog-content">
                                                    ...
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">I Only Packed 9 Pieces for a Trip to <br/> Europe and My OOTDs Still Hit</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/28.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">25 Flat Shoes You Can Walk in All <br/> Spring and Summer Long</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/29.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">I’m Plus-Size: These Are My No-Fail <br/> Date Night Outfits</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="featured-post area-2 fashion tp-section-gapBottom">
                                <div className="section-title-area">
                                ...
                                <div className="post-section-inner">
                                    <div className="row g-5">
                                        <div className="col-lg-12">
                                            <div className="eblog-featured-news style-two big">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/30.jpg" alt=""/></a>
                                                ...
                                                <div className="blog-content">
                                                    ...
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">The Under-$100 Items We’re Adding <br/> to Our Carts for Spring</a></h4>
                                                    <a href="#" className="text-btn color-two">Continue Reading</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/31.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">Women in AI: Anna Korhonen <br/> studies the intersection</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/32.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">How To Make Your Skinny Jeans <br/> Look Cool in 2024</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/33.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">​7 Outfits Monica Geller Wore <br/> That I’d Still Wear Today</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="featured-post area-2 hollywood tp-section-gapBottom">
                                <div className="section-title-area">
                                    <h3 className="section-title">Fashion</h3>
                                </div>
                                <div className="post-section-inner">
                                    <div className="row g-5">
                                        <div className="col-lg-12">
                                            <div className="eblog-featured-news style-two big">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/34.jpg" alt=""/></a>
                                                    <p className="tag">Fashion</p>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        ...
                                                        <li>
                                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g clipPath="url(#clip0_4238_1237)">
                                                                    <path fillRule="evenodd" clipRule="evenodd" d="M3.85407 12.9565C4.93327 13.6776 6.20206 14.0625 7.5 14.0625C9.24049 14.0625 10.9097 13.3711 12.1404 12.1404C13.3711 10.9097 14.0625 9.24049 14.0625 7.5C14.0625 6.20206 13.6776 4.93327 12.9565 3.85407C12.2354 2.77488 11.2105 1.93374 10.0114 1.43704C8.81222 0.940343 7.49272 0.810384 6.21972 1.0636C4.94672 1.31682 3.7774 1.94183 2.85961 2.85961C1.94183 3.7774 1.31682 4.94672 1.0636 6.21972C0.810384 7.49272 0.940343 8.81222 1.43704 10.0114C1.93374 11.2105 2.77488 12.2354 3.85407 12.9565ZM4.37492 2.82299C5.29995 2.2049 6.38748 1.875 7.5 1.875C8.99185 1.875 10.4226 2.46764 11.4775 3.52253C12.5324 4.57742 13.125 6.00816 13.125 7.5C13.125 8.61252 12.7951 9.70006 12.177 10.6251C11.5589 11.5501 10.6804 12.2711 9.6526 12.6968C8.62476 13.1226 7.49376 13.234 6.40262 13.0169C5.31148 12.7999 4.3092 12.2641 3.52253 11.4775C2.73586 10.6908 2.20013 9.68853 1.98309 8.59739C1.76604 7.50624 1.87744 6.37524 2.30318 5.34741C2.72892 4.31957 3.44989 3.44107 4.37492 2.82299ZM7.03125 7.69219L9.65156 10.3125L10.3125 9.65156L7.96875 7.30312V3.28125H7.03125V7.69219Z" fill="#1E1E1E" />
                                                                </g>
                                                                <defs>
                                                    ...
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">The Shoes That Are Replacing Our <br/> Sneakers This Spring</a></h4>
                                                    <a href="#" className="text-btn color-two">Continue Reading</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/35.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">PSA: J.Crew’s Having a Massive <br/> 30% Off Sale RN</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/36.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">Our Favorite Cozy Pieces to Get <br/> You Through Winter</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/37.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content">
                                                    <ul className="blog-meta">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                    <h4 className="heading-title"><a className="title-animation text-center" href="#">Want to Be As Confident as <br/> Rihanna? Here Are Her Best Tips</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="featured-post area-2 latest-news2">
                                <div className="section-title-area">
                                    <h3 className="section-title">Fashion</h3>
                                </div>
                                <div className="post-section-inner">
                                    <div className="row g-5">
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/38.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content text-left">
                                                    <p className="tag mb--15">Fashion</p>
                                                    <h4 className="heading-title ml--0 mb--10 text-start"><a className="title-animation text-center" href="#">The Best Life Lessons ‘Ted <br/> Lasso’ Taught Me</a></h4>
                                                    <ul className="blog-meta justify-content-start m--0">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/39.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content text-left">
                                                    <p className="tag mb--15">Fashion</p>
                                                    <h4 className="heading-title ml--0 mb--10 text-start"><a className="title-animation text-center" href="#">Efficient Rules How Working <br/> Place Relationship </a></h4>
                                                    <ul className="blog-meta justify-content-start m--0">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/40.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content text-left">
                                                    <p className="tag mb--15">Fashion</p>
                                                    <h4 className="heading-title ml--0 mb--10 text-start"><a className="title-animation text-center" href="#">How To Make Your Skinny <br/> Jeans Look Cool in 2024</a></h4>
                                                    <ul className="blog-meta justify-content-start m--0">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/41.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content text-left">
                                                    <p className="tag mb--15">Fashion</p>
                                                    <h4 className="heading-title ml--0 mb--10 text-start"><a className="title-animation text-center" href="#">Want to Be As Confident as <br/> Rihanna? Here Are Her Best</a></h4>
                                                    <ul className="blog-meta justify-content-start m--0">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/42.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content text-left">
                                                    <p className="tag mb--15">Fashion</p>
                                                    <h4 className="heading-title ml--0 mb--10 text-start"><a className="title-animation text-center" href="#">25 Flat Shoes You Can Walk in <br/> Spring and Summer Long</a></h4>
                                                    <ul className="blog-meta justify-content-start m--0">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="eblog-featured-news style-two small">
                                                <div className="image-area">
                                                    <a href="#"><img src="/images/blog/43.jpg" alt=""/></a>
                                                </div>
                                                <div className="blog-content text-left">
                                                    <p className="tag mb--15">Fashion</p>
                                                    <h4 className="heading-title ml--0 mb--10 text-start"><a className="title-animation text-center" href="#">8 Holiday Travel Tips for the <br/> Busiest Time of Year</a></h4>
                                                    <ul className="blog-meta justify-content-start m--0">
                                                        <li className="author"><span>BY</span>Elon Mask - 14 Jan, 2024 </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="button-area">
                                                <a href="#" className="tp-btn btn-secondary m-auto">Load More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="col-xl-3 tp-sticky-column-item">
                        <div className="eblog-right-sidebar area-2">
                                ...
                                <div className="featured-post sidebar">
                                    ...
                                    <div className="blog-content">
                                        <ul className="blog-meta">
                                            <li>
                                                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clipPath="url(#clip0_4238_1238)">
                                                        <path fillRule="evenodd" clipRule="evenodd" d="M3.85407 12.9565C4.93327 13.6776 6.20206 14.0625 7.5 14.0625C9.24049 14.0625 10.9097 13.3711 12.1404 12.1404C13.3711 10.9097 14.0625 9.24049 14.0625 7.5C14.0625 6.20206 13.6776 4.93327 12.9565 3.85407C12.2354 2.77488 11.2105 1.93374 10.0114 1.43704C8.81222 0.940343 7.49272 0.810384 6.21972 1.0636C4.94672 1.31682 3.7774 1.94183 2.85961 2.85961C1.94183 3.7774 1.31682 4.94672 1.0636 6.21972C0.810384 7.49272 0.940343 8.81222 1.43704 10.0114C1.93374 11.2105 2.77488 12.2354 3.85407 12.9565ZM4.37492 2.82299C5.29995 2.2049 6.38748 1.875 7.5 1.875C8.99185 1.875 10.4226 2.46764 11.4775 3.52253C12.5324 4.57742 13.125 6.00816 13.125 7.5C13.125 8.61252 12.7951 9.70006 12.177 10.6251C11.5589 11.5501 10.6804 12.2711 9.6526 12.6968C8.62476 13.1226 7.49376 13.234 6.40262 13.0169C5.31148 12.7999 4.3092 12.2641 3.52253 11.4775C2.73586 10.6908 2.20013 9.68853 1.98309 8.59739C1.76604 7.50624 1.87744 6.37524 2.30318 5.34741C2.72892 4.31957 3.44989 3.44107 4.37492 2.82299ZM7.03125 7.69219L9.65156 10.3125L10.3125 9.65156L7.96875 7.30312V3.28125H7.03125V7.69219Z" fill="#1E1E1E" />
                                                    </g>
                                                    <defs>
                                        ...
                                        <h5 className="heading-title"><a className="title-animation" href="#">So Long, Winter: These Are The <br/> 7 Best Trends of Spring 2024</a></h5>
                                        <p className="author"><em>by</em> Dany</p>
                                        <a href="#" className="text-btn color-two">Read More</a>
                                    </div>
                                </div>
                            </div>
                            <div className="eblog-right-side-post popular">
                                ...
                                <div className="small-post">
                                    <div className="eblog-post-list-style">
                                        <div className="image-area">
                                            <a href="#"><img src="/images/blog/45.jpg" alt=""/></a>
                                        </div>
                                        <div className="blog-content">
                                            <h4 className="heading-title"><a className="title-animation" href="#">The Lazy Girl’s Guide to Always Put Together</a></h4>
                                            <ul className="blog-meta">
                                                <li>
                                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clipPath="url(#clip0_4238_1239)">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M3.85407 12.9565C4.93327 13.6776 6.20206 14.0625 7.5 14.0625C9.24049 14.0625 10.9097 13.3711 12.1404 12.1404C13.3711 10.9097 14.0625 9.24049 14.0625 7.5C14.0625 6.20206 13.6776 4.93327 12.9565 3.85407C12.2354 2.77488 11.2105 1.93374 10.0114 1.43704C8.81222 0.940343 7.49272 0.810384 6.21972 1.0636C4.94672 1.31682 3.7774 1.94183 2.85961 2.85961C1.94183 3.7774 1.31682 4.94672 1.0636 6.21972C0.810384 7.49272 0.940343 8.81222 1.43704 10.0114C1.93374 11.2105 2.77488 12.2354 3.85407 12.9565ZM4.37492 2.82299C5.29995 2.2049 6.38748 1.875 7.5 1.875C8.99185 1.875 10.4226 2.46764 11.4775 3.52253C12.5324 4.57742 13.125 6.00816 13.125 7.5C13.125 8.61252 12.7951 9.70006 12.177 10.6251C11.5589 11.5501 10.6804 12.2711 9.6526 12.6968C8.62476 13.1226 7.49376 13.234 6.40262 13.0169C5.31148 12.7999 4.3092 12.2641 3.52253 11.4775C2.73586 10.6908 2.20013 9.68853 1.98309 8.59739C1.76604 7.50624 1.87744 6.37524 2.30318 5.34741C2.72892 4.31957 3.44989 3.44107 4.37492 2.82299ZM7.03125 7.69219L9.65156 10.3125L10.3125 9.65156L7.96875 7.30312V3.28125H7.03125V7.69219Z" fill="#1E1E1E" />
                                                        </g>
                                                        <defs>
                                    ...
                                    <div className="eblog-post-list-style">
                                        <div className="image-area">
                                            <a href="#"><img src="/images/blog/46.jpg" alt=""/></a>
                                        </div>
                                        <div className="blog-content">
                                            <h4 className="heading-title"><a className="title-animation" href="#">The Everygirl’s Spring 2024 Capsule Wardrobe</a></h4>
                                            <ul className="blog-meta">
                                                <li>
                                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clipPath="url(#clip0_4238_1240)">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M3.85407 12.9565C4.93327 13.6776 6.20206 14.0625 7.5 14.0625C9.24049 14.0625 10.9097 13.3711 12.1404 12.1404C13.3711 10.9097 14.0625 9.24049 14.0625 7.5C14.0625 6.20206 13.6776 4.93327 12.9565 3.85407C12.2354 2.77488 11.2105 1.93374 10.0114 1.43704C8.81222 0.940343 7.49272 0.810384 6.21972 1.0636C4.94672 1.31682 3.7774 1.94183 2.85961 2.85961C1.94183 3.7774 1.31682 4.94672 1.0636 6.21972C0.810384 7.49272 0.940343 8.81222 1.43704 10.0114C1.93374 11.2105 2.77488 12.2354 3.85407 12.9565ZM4.37492 2.82299C5.29995 2.2049 6.38748 1.875 7.5 1.875C8.99185 1.875 10.4226 2.46764 11.4775 3.52253C12.5324 4.57742 13.125 6.00816 13.125 7.5C13.125 8.61252 12.7951 9.70006 12.177 10.6251C11.5589 11.5501 10.6804 12.2711 9.6526 12.6968C8.62476 13.1226 7.49376 13.234 6.40262 13.0169C5.31148 12.7999 4.3092 12.2641 3.52253 11.4775C2.73586 10.6908 2.20013 9.68853 1.98309 8.59739C1.76604 7.50624 1.87744 6.37524 2.30318 5.34741C2.72892 4.31957 3.44989 3.44107 4.37492 2.82299ZM7.03125 7.69219L9.65156 10.3125L10.3125 9.65156L7.96875 7.30312V3.28125H7.03125V7.69219Z" fill="#1E1E1E" />
                                                        </g>
                                                        <defs>
                                    ...
                                    <div className="eblog-post-list-style">
                                        <div className="image-area">
                                            <a href="#"><img src="/images/blog/47.jpg" alt=""/></a>
                                        </div>
                                        <div className="blog-content">
                                            <h4 className="heading-title"><a className="title-animation" href="#">7 Wardrobe Staples Thats Are Better Secondhand</a></h4>
                                            <ul className="blog-meta">
                                                <li>
                                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clipPath="url(#clip0_4238_1241)">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M3.85407 12.9565C4.93327 13.6776 6.20206 14.0625 7.5 14.0625C9.24049 14.0625 10.9097 13.3711 12.1404 12.1404C13.3711 10.9097 14.0625 9.24049 14.0625 7.5C14.0625 6.20206 13.6776 4.93327 12.9565 3.85407C12.2354 2.77488 11.2105 1.93374 10.0114 1.43704C8.81222 0.940343 7.49272 0.810384 6.21972 1.0636C4.94672 1.31682 3.7774 1.94183 2.85961 2.85961C1.94183 3.7774 1.31682 4.94672 1.0636 6.21972C0.810384 7.49272 0.940343 8.81222 1.43704 10.0114C1.93374 11.2105 2.77488 12.2354 3.85407 12.9565ZM4.37492 2.82299C5.29995 2.2049 6.38748 1.875 7.5 1.875C8.99185 1.875 10.4226 2.46764 11.4775 3.52253C12.5324 4.57742 13.125 6.00816 13.125 7.5C13.125 8.61252 12.7951 9.70006 12.177 10.6251C11.5589 11.5501 10.6804 12.2711 9.6526 12.6968C8.62476 13.1226 7.49376 13.234 6.40262 13.0169C5.31148 12.7999 4.3092 12.2641 3.52253 11.4775C2.73586 10.6908 2.20013 9.68853 1.98309 8.59739C1.76604 7.50624 1.87744 6.37524 2.30318 5.34741C2.72892 4.31957 3.44989 3.44107 4.37492 2.82299ZM7.03125 7.69219L9.65156 10.3125L10.3125 9.65156L7.96875 7.30312V3.28125H7.03125V7.69219Z" fill="#1E1E1E" />
                                                        </g>
                                                        <defs>
                                    ...
                                    <div className="eblog-post-list-style">
                                        <div className="image-area">
                                            <a href="#"><img src="/images/blog/48.jpg" alt=""/></a>
                                        </div>
                                        <div className="blog-content">
                                            <h4 className="heading-title"><a className="title-animation" href="#">Apple introduces sustainable repair options with used</a></h4>
                                            <ul className="blog-meta">
                                                <li>
                                                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clipPath="url(#clip0_4238_1242)">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M3.85407 12.9565C4.93327 13.6776 6.20206 14.0625 7.5 14.0625C9.24049 14.0625 10.9097 13.3711 12.1404 12.1404C13.3711 10.9097 14.0625 9.24049 14.0625 7.5C14.0625 6.20206 13.6776 4.93327 12.9565 3.85407C12.2354 2.77488 11.2105 1.93374 10.0114 1.43704C8.81222 0.940343 7.49272 0.810384 6.21972 1.0636C4.94672 1.31682 3.7774 1.94183 2.85961 2.85961C1.94183 3.7774 1.31682 4.94672 1.0636 6.21972C0.810384 7.49272 0.940343 8.81222 1.43704 10.0114C1.93374 11.2105 2.77488 12.2354 3.85407 12.9565ZM4.37492 2.82299C5.29995 2.2049 6.38748 1.875 7.5 1.875C8.99185 1.875 10.4226 2.46764 11.4775 3.52253C12.5324 4.57742 13.125 6.00816 13.125 7.5C13.125 8.61252 12.7951 9.70006 12.177 10.6251C11.5589 11.5501 10.6804 12.2711 9.6526 12.6968C8.62476 13.1226 7.49376 13.234 6.40262 13.0169C5.31148 12.7999 4.3092 12.2641 3.52253 11.4775C2.73586 10.6908 2.20013 9.68853 1.98309 8.59739C1.76604 7.50624 1.87744 6.37524 2.30318 5.34741C2.72892 4.31957 3.44989 3.44107 4.37492 2.82299ZM7.03125 7.69219L9.65156 10.3125L10.3125 9.65156L7.96875 7.30312V3.28125H7.03125V7.69219Z" fill="#1E1E1E" />
                                                        </g>
                                                        <defs>
                            ...
                            <div className="eblog-right-side-post category2">
                                ...
                                <div className="category-area">
                                    <ul className="category-wrapper">
                                        <li>
                                            <div className="image-area">
                                                <a href="#"><img src="/images/category/category-04.jpg" alt=""/></a>
                                                <p className="text"><a href="#">Fashion</a></p>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="image-area">
                                                <a href="#"><img src="/images/category/category-05.jpg" alt=""/></a>
                                                <p className="text"><a href="#">Life Style </a></p>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="image-area">
                                                <a href="#"><img src="/images/category/category-06.jpg" alt=""/></a>
                                                <p className="text"><a href="#">Travel</a></p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clipPath="url(#clip0_4219_1420)">
                            ...
                            <div className="eblog-right-side-post newsletter">
                                <p className="title">Subscribe News Letter</p>
                                <div className="newsletter-area area-2">
                                    <form action="#">
                                        <div className="form-inner">
                                            ...
                                            <div className="single-input-wrapper">
                                                <button type="submit" className="subscribe-btn tp-btn">Subscribe</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <div className="eblog-right-side-post ad">
                                <div className="eblog-ad-area">
                                    <img src="/images/banner/ad-02.jpg" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
